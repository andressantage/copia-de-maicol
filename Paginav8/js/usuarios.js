import { getuSET,nuewUSET,deleteUset,getCategoria} from "../API/API.js";
...
async function cargarTablas (){
    ...
    const infocateorias = await getuSET()
    infocateorias.forEach(element => {
        const {id,usuario,contraseña,nombre} = element
